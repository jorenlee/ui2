...
const lazyViewMap = {
  ViewContentList: { loader: () => import("~/components/SuperAdminDashboard/CMS/List.vue"), class: "p-4 pb-32" },
  ViewLibraryAppointments: { loader: () => import("~/components/SuperAdminDashboard/Library/reserved/index.vue"), class: "pb-32" },
  ViewLibraryBooks: { loader: () => import("~/components/SuperAdminDashboard/Library/books/index.vue"), class: "pb-32" },
  ViewLibrarySchedules: { loader: () => import("~/components/SuperAdminDashboard/Library/schedules/index.vue"), class: "pb-24" },
  ...
  ViewUniversityCalendar: { loader: () => import("~/components/SuperAdminDashboard/ChancellorOffice/index.vue"), class: "p-4 pb-32" },
  ViewNPCCManagement: { loader: () => import("~/components/SuperAdminDashboard/NPCC/index.vue"), class: "px-2 pb-32" },
  ViewRegistrarAppointments: { loader: () => import("~/components/SuperAdminDashboard/Registrar/index.vue"), class: "pb-32" },
  ViewCampusPassRequests: { loader: () => import("~/components/SuperAdminDashboard/CampusPass/index.vue"), class: "pb-32" },
  ViewDRSList: { loader: () => import("~/components/SuperAdminDashboard/DocumentReviewSystem/List.vue"), class: "pb-32" },
  ViewDRSForm: { loader: () => import("~/components/SuperAdminDashboard/DocumentReviewSystem/Form.vue"), class: "pb-20" },
  ...
  ViewCurrentEmployedAdmins: { loader: () => import("~/components/SuperAdminDashboard/HumanResource/EmployedAdmins.vue"), class: "pb-32" },
  ...
  ViewOERForm: { loader: () => import("~/components/SuperAdminDashboard/OER/Form.vue"), class: "pb-32" },
  ViewOERList: { loader: () => import("~/components/SuperAdminDashboard/OER/List.vue"), class: "pb-32" },
