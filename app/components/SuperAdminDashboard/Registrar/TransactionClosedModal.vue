    ...
    <div v-if="showTransactionClosedModal"
        ...
        <div class="rounded-xl shadow-2xl p-6 w-full max-w-md mx-4 transform transition-transform duration-300" :class="[
            ...
            <div class="flex justify-between items-center mb-4 border-b pb-3" :class="darkMode ? 'border-gray-700' : 'border-gray-200'
                ...
                <button @click="$emit('closeTransactionClosedModal')" class="hover:text-gray-500" :class="darkMode ? 'text-gray-400' : 'text-gray-400'
                    ">
            ...
            <!-- Verified Button -->
            <div @click="$emit('confirmTransactionClosed', currentItem)"
...
<script setup>
    const props = defineProps({
        showTransactionClosedModal: Boolean,
        currentItem: Object,
        darkMode: Boolean,
        isConfirming: Boolean,
    });

    const emit = defineEmits(['closeTransactionClosedModal', 'confirmTransactionClosed']);
</script>