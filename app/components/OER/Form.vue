...
const info = ref({
    // Contributor
    contributor_name: user.value?.name,
    program: "",
    college_or_unit: "",
    contributor_email: user.value?.email,
...
const availablePrograms = computed(() => programsByCollege.value[info.value.college_or_unit] || []);
                    ...
                    <div class="w-11/12 mx-auto bg-white">
                        <form v-on:submit.prevent="postAPI" class="">
                            <div class="border-2 border-green-700 shadow-lg my-3">
                                <div class="">
                                    <h2
                                        class="lg:text-base text-sm px-3 uppercase py-1.5 font-bold bg-green-900 text-center tracking-wide text-white">
                                        Document Information
                                    </h2>

                                    <div class="space-y-8 bg-gray-50 text-black">
                                        <div class="">


                                            <!-- Resource Information Tab -->
                                            <div class="rounded-xl shadow-sm p-4 lg:p-6 space-y-4">
                                                <div
                                                    class="flex items-center gap-2 text-green-800 font-semibold text-base">

                                                    <h3>I. Resource Information</h3>
                                                ...
                                                <div class="">
                                                    <div class="lg:flex gap-4 mb-4">
                                                        ...
                                                        <div class="w-full lg:mb-0 mb-4">
                                                            ...
                                                            <input type="text" placeholder="Enter your full name"
                                                                v-model="info.contributor_name" required
                                                                class="w-full capitalize  border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2" />
                                                        </div>
                                                        <!-- Email -->
                                                        <div class="w-full lg:mb-0 mb-4">
                                                            <label class="block text-xs font-bold text-gray-700 mb-1">
                                                            ...
                                                            <input type="email" placeholder="your.name@lsu.edu.ph"
                                                                v-model="info.contributor_email" required
                                                                class="w-full  border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2" />
                                                        </div>
                                                        <!-- College or Unit -->
                                                        <div class="w-full lg:mb-0 mb-4">
                                                            <label class="block text-xs font-bold text-gray-700 mb-1">
                                                            ...
                                                            <select v-model="info.college_or_unit"
                                                                @change="onCollegeChange" required
                                                                class="w-full  border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2">
                                                                <option value="" disabled>
                                                                    Select College or Unit
                                                                </option>
                                                                <option v-for="college in collegeList" :key="college"
                                                                    :value="college">
                                                                    {{ college }}
                                                                </option>
                                                            </select>
                                                        ...
                                                        <div class="w-full" v-if="showProgramField">
                                                            ...
                                                            <select v-model="info.program" required
                                                                class="w-full  border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2">
                                                                <option value="" disabled>
                                                                    Select Program
                                                                </option>
                                                                <option v-for="program in availablePrograms"
                                                    ...
                                                    <div class="lg:flex gap-4 w-full mb-4">
                                                        ...
                                                        <div class="w-full">
                                                            ...
                                                            <input type="text" placeholder="Enter resource title"
                                                                v-model="info.title" required
                                                                class="w-full border-b border-green-700 focus:ring-2 focus:ring-blue-600 text-sm px-3 py-2" />
                                                        </div>
                                                        ...
                                                        <div class="w-full">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                v-model="info.author_and_affiliation" required
                                                                class="w-full border-b border-green-700 focus:ring-2 focus:ring-blue-600 text-sm px-3 py-2" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="w-full mb-4">
                                                        ...
                                                        <textarea
                                                            ...
                                                            v-model="info.description_abstract" required rows="1"
                                                            class="w-full border-b border-green-700 focus:ring-2 focus:ring-blue-600 text-sm px-3 py-2">
                                                            </textarea>
                                                    </div>
                                                    ...
                                                    <div class="lg:flex gap-x-4">
                                                        <div class="lg:w-3/12 w-full">
                                                            ...
                                                            <div
                                                                class="flex gap-x-10 w-full border-b border-green-700 focus:ring-2 focus:ring-blue-600 text-sm px-3 py-2">
                                                                <label
                                                        ...
                                                        <div class="lg:flex gap-4 w-full">
                                                            ...
                                                            <div class="w-full lg:flex gap-x-4"
                                                                ...
                                                                <div class="w-full">
                                                                    ...
                                                                    <input type="file"
                                                                        ...
                                                                        class="w-full border-b border-green-700 focus:ring-2 focus:ring-blue-600 text-sm px-3 py-1.5" />
                                                                </div>

                                                                <div class="" v-if="selectedResourceFiles.length > 0">
                                                                    <div
                                                                    ...
                                                                    <div v-if="uploadStatusResourceFiles"
                                                                        class="mt-1 text-xs" :class="uploadStatusResourceFiles.includes(
                                                                            'failed'
                                                                        )
                                                                            ? 'text-red-600'
                                                                            : 'text-green-600'
                                                                    ...
                                                                    <div v-if="uploadedResourceFiles.length > 0"
                                                                        class="mt-2">
                                                                        <p class="text-xs text-gray-600 mb-1">
                                                                            Uploaded Files:
                                                                        </p>
                                                                        <div v-for="file in uploadedResourceFiles"
                                                                            :key="file.url"
                                                            ...
                                                            <div class="w-full" v-if="info.type_of_entry === 'Video'">
                                                                <label
                                                                    class="block text-xs font-bold text-gray-700 mb-1">
                                                                    Video Link
                                                                    <span class="text-red-600">*</span>
                                                    ...
                                                    <div class="w-full lg:flex gap-x-4">
                                                        <div class="w-full lg:flex gap-x-4">
                                                            ...
                                                            <div class="w-full">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    v-model="info.subject_areas" required
                                                                    class="w-full border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2" />
                                                            </div>
                                                            <!-- Keywords -->
                                                            <div class="w-full">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    v-model="info.keywords" required
                                                                    class="w-full border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="w-full lg:flex gap-4 mb-4">
                                                            ...
                                                            <div class="w-full">
                                                                ...
                                                                <select v-model="info.target_audience" required
                                                                    class="w-full border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2">
                                                                    <option value="" disabled selected>
                                                                        Select Target Audience
                                                                    </option>
                                                                    <option v-for="audience in targetAudienceList"
                                                            ...
                                                            <div class="w-full">
                                                                ...
                                                                <!-- License Type -->
                                                                <select v-model="info.license_chosen" required
                                                                    class="w-full border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2">
                                                                    <option value="" disabled selected>
                                                                        Select License Type
                                                                    </option>
                                                            ...
                                                            <div class="w-full">
                                                                ...
                                                                <!-- Language -->
                                                                <select v-model="info.languages" required
                                                                    class="w-full border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2">
                                                                    <option value="" disabled selected>
                                                                        Select Language
                                                                    </option>
                                                                    <option v-for="language in languageList"
                                                    ...
                                                    <div class="lg:flex gap-4">
                                                        ...
                                                        <div class="w-full">
                                                            ...
                                                            <textarea
                                                                ...
                                                                v-model="info.learning_objectives" rows="2"
                                                                class="w-full border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2"></textarea>
                                                        </div>
                                                        <!-- Accessibility Notes -->
                                                        <div class="w-full">
                                                            <label class="block text-xs font-bold text-gray-700 mb-1">
                                                            ...
                                                            <textarea
                                                                ...
                                                                v-model="info.accessibility_notes" rows="2"
                                                                class="w-full border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2"></textarea>
                                                        </div>
                                                        <!-- Lasallian Relevance -->
                                                        <div class="w-full">
                                                            ...
                                                            <textarea
                                                                ...
                                                                v-model="info.lasallian_relevance" rows="2"
                                                                class="w-full border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2"></textarea>
                                                        </div>
                                                        ...
                                                        <div class="w-full">
                                                            ...
                                                            <textarea
                                                                ...
                                                                v-model="info.relation_to_other_resources" rows="2"
                                                                class="w-full border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2"></textarea>
                                                        </div>
                                                        <!-- Source Attribution -->
                                                        <div class="w-full">
                                                            ...
                                                            <textarea
                                                                ...
                                                                v-model="info.source_attribution" rows="2"
                                                                class="w-full border-b border-green-700 focus:ring-2 focus:ring-green-600 text-sm px-3 py-2"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="space-y-4 py-10">
                                                <button type="button"
                                                    class="px-4 py-2 bg-green-700 text-white rounded hover:bg-green-800 mx-auto w-4/12 block"
                                                    :disabled="isSubmitting" @click="postAPI">
