...
<template>
  <div class="bg-gray-50">
    ...
    <div class="">
      ...
      <div
        class="text-center mb-4 py-5 px-36 shadow-lg border-t lg:block hidden"
      >
        <h1 class="uppercase font-bold lg:text-xl text-lg">Announcement:</h1>
        <p class="mb-3 text-xs">
          (Due to System Updates, Server Maintenance and Power Interruptions)
        </p>
        <div>
          <div class="mb-3">
            <p class="lg:text-sm text-xs lg:w-10/12 mx-auto">
              ...
              <span class="font-bold uppercase"
                >New Students (incoming 1st Year, Transferees and Second Degree
                Holders)</span
              >
              from July 1 to 4, 2024 that applied for temporary admission,
              please go to
              <span class="font-bold">Admissions and Scholarships Office</span>
              or email <span class="font-bold">admissions@lsu.edu.ph</span>
              to get your new LSU Tracking ID Number (for Enrollment Status and
              Remarks).
            </p>
          </div>
          <div>
            <p class="lg:text-sm text-xs">
              To all
              <span class="font-bold uppercase">continuing students</span> from
              July 1 to 4, 2024 that applied for temporary admission, new LSU
              Tracking ID Number (for Enrollment Status and Remarks) will be
              sent to your LSU Gmail Account. All continuing students are
              required to use the correct LSU Gmail (no misspelled) along with
              their personal email when filling out the form; otherwise, the
              application will be deleted.
            </p>
          </div>
        </div>

        <div class="text-green-800 lg:text-sm text-sm mt-3 font-bold">
          If you have any concerns please visit Admissions and Scholarships
          Office, SJ Building Ground Floor LSU Campus. Monday to Friday 8am to
          5pm and Saturday 8am to 12nn. Thank you!
        </div>
      </div>

      <div class="lg:flex w-11/12 mx-auto lg:mt-2 mb-5">
        <div
          class="lg:w-7/12 mx-auto items-center lg:shadow-lg lg:order-2 order-1 lg:border-t-2"
        >
              ...
              <div class="text-center justify-center gap-10 py-5 lg:my-14">
                ...
                <div class="lg:mb-10 mb-4">
                  <a
                    ...
                    class="rounded-lg lg:py-6 py-3 lg:px-10 px-3 my-auto justify-center h-fit lg:w-10/12 mx-auto shadow-xl bg-white text-green-800 hover:bg-green-800 hover:text-white lg:text-sm text-xs font-bold flex"
                  >
                    <i class="fa fa-tasks mr-5 text-3xl" aria-hidden="true"></i>
                    <h1 class="my-auto lg:text-lg text-sm">
                      Enrollment Tracking
                    </h1>
                  </a>
                </div>
        ...
        <div
          class="font-bold text-white bg-green-900 lg:text-2xl text-center py-5 leading-tight text-sm px-5 lg:hidden block"
        >
          The Enrollment Period for the First Semester of Academic Year 2024 to
          2025 is from July 1 to July 31, 2024.
        </div>
        <div
          class="text-center mb-5 py-5 lg:px-5 px-3 shadow-lg border-t lg:hidden block"
        >
          <h1 class="uppercase font-bold lg:text-2xl text-lg">Announcement:</h1>
          ...
          <div>
            <div class="mb-5">
              <p class="lg:text-sm text-xs lg:w-10/12 mx-auto">
                To all
                <span class="font-bold uppercase"
                  >New Students (incoming 1st Year, Transferees and Second
                  Degree Holders)</span
                >
                from July 1 to 4, 2024 that applied for temporary admission,
                please go to
                <span class="font-bold"
                  >Admissions and Scholarships Office</span
                >
                or email <span class="font-bold">admissions@lsu.edu.ph</span>
                to get your new LSU Tracking ID Number (for Enrollment Status
                and Remarks).
              </p>
            </div>
            <div>
              <p class="lg:text-sm text-xs">
                To all
                <span class="font-bold uppercase">continuing students</span>
                from July 1 to 4, 2024 that applied for temporary admission, new
                LSU Tracking ID Number (for Enrollment Status and Remarks) will
                be sent to your LSU Gmail Account.
              </p>
            </div>
          </div>

          <div class="lg:text-sm text-sm mt-5 font-bold">
            All continuing students are required to use the correct LSU Gmail
            (no misspelled) along with their personal email when filling out the
            form; otherwise, the application will be deleted.
          </div>

          <div class="text-green-800 lg:text-sm text-sm mt-5 font-bold">
            If you have any concerns please visit Admissions and Scholarships
            Office, SJ Building Ground Floor LSU Campus. Monday to Friday 8am to
            5pm and Saturday 8am to 12nn. Thank you!
          </div>
        ...
        <div
          class="w-full shadow-lg lg:px-10 px-2 lg:order-1 order-2 border-t-2 lg:mt-0 mt-5"
        >
          <div class="w-full mx-auto text-center my-5">
            <p
              class="font-bold text-green-900 lg:text-3xl text-xl lg:mb-3 mb-5 lg:mt-2 mt-5"
            >
              Enrollment Steps
            </p>
            <ul class="w-full grid lg:grid-cols-2 justify-between gap-5">
              <li
                class="w-full border bg-white text-green-800 hover:text-white hover:bg-green-800"
              >
                <span
                  class="justify-evenly border-b flex p-5 bg-green-800 text-white py-1 font-bold"
                >
              ...
              <li class="w-full border text-white bg-white">
                <span
                  class="justify-between flex p-5 bg-green-800 py-1 font-bold"
                >
                  <span class="w-full">Step 2:</span>
                  <span class="w-full uppercase">Advising</span>
                </span>
                <span
                  class="text-green-800 font-bold w-full flex justify-center lg:p-4 p-3 lg:pt-5"
                >
              ...
              <li class="w-full lg:mb-5 border text-white">
                ...
                <span
                  class="bg-white border-b text-green-800 font-bold w-full flex justify-center p-4"
                >
              ...
              <li class="w-full lg:mb-5 text-white mb-7">
                ...
                <span
                  class="bg-white text-green-800 font-bold border w-full flex justify-center p-4"
                >
                ...
                >
                  ...
                  <p class="lg:text-sm text-xs">
                    ...
                    profile; otherwise, they will be deactivated.
                  </p>
                </div>
              </li>
            </ul>
      ...
      <div
        class="font-bold text-white bg-green-900 lg:text-lg text-center py-5 w-11/12 mx-auto leading-tight text-sm px-5 lg:block hidden my-5"
      >
        The Enrollment Period for the First Semester of Academic Year 2024 to
        2025 is from July 1 to July 31, 2024.
      </div>
      ...
      <div
        class="w-full h-full shadow-4xl lg:block hidden"
        v-if="paymentMethodImage"
      >
        <img
          @click="paymentMethodImage = !paymentMethodImage"
          src="https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/banners/PaymentMethods.jpg"
