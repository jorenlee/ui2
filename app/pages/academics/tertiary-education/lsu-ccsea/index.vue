...
<div class="font-montserrat w-full mx-auto my-5 px-5"> 
  <div class=" py-5 px-5 shadow">
    ...
    <img src="https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/banners/logo/colleges/ccsea.png" 
    class="w-32 mx-auto my-3 rounded-full" />

    <h1 class="text-center mt-0 text-lg"> COLLEGE OF COMPUTER STUDIES,
      ENGINEERING AND ARCHITECTURE </h1>
<h2 class="text-center mt-5 text-md bg-green-700 text-white py-2"> BACHELOR OF SCIENCE IN ARCHITECTURE </h2>
<p class="text-sm text-center py-5" > The practice of architecture is the act of planning and architectural designing,
structural conceptualization, designing if built structure and environment,
specifying, supervising, and giving general administration and responsible
direction to the erection, enlargement and alterations of buildings and building
environments and architectural design in engineering structures or any part
thereof. </p>

    <h2 class="text-center mt-5 text-md bg-green-700 text-white py-2"> BACHELOR OF SCIENCE IN COMPUTER ENGINEERING (PAASCU

ACCREDITED) </h2>
<p class="text-sm text-center py-5" > A program that embodies science and technology of design, development,
implementation, maintenance and integration of software and hardware
components in modern computing systems and computer-controlled
equipment. </p>
