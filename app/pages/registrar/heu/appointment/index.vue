      ...
      <div class="lg:gap-x-2 gap-x-1 w-full p-2 bg-white">
        <div class="lg:flex gap-x-2">
          <div class="w-full mb-2">
            <label class="lg:text-xs text-[10px] text-green-950 pb-2 font-bold whitespace-nowrap lg:w-6/12">
              <div class="">
                Fullname
          ...
          <div class="lg:w-fit w-full mb-2">
            ...
            <div
              ...
              <input type="date" class="px-1 w-full border-t-0 border-x-0 border-green-700 lg:h-[34px] h-8 text-xs"
                placeholder="Date of Birth" :min="minBirthDate" :max="maxBirthDate" v-model="info.birthdate" required />
            </div>
          </div>
          ...
          <div class="lg:w-9/12 w-full mb-2">
            ...
            <div
              class="w-full flex items-center gap-x-1 bg-white border-b-2 border-green-700 shadow-lg rounded-sm h-fit">
              <input type="text" class="px-2 w-full border-t-0 border-x-0 border-green-700 lg:h-9 h-8 text-xs py-2"
                placeholder="Mother's Full Maiden Name" v-model="info.mother_maiden_name" required />
            </div>
          </div>
          ...
          <div class="lg:w-6/12 w-full mb-2">
            ...
            <div
              ...
              <input type="tel" inputmode="tel" autocomplete="tel"
                ...
                placeholder="e.g. +639210689089" v-model="info.contact_number" @focus="onContactFocus"
                @input="onContactInput" @keydown="onContactKeydown" pattern="^(\+63|\+65)[0-9]{9,10}$" maxlength="13"
          ...
          <div class="lg:w-10/12 w-full mb-2">
            ...
            <div
              class="w-full flex items-center gap-x-1 bg-white border-b-2 border-green-700 shadow-lg rounded-sm h-fit">
              <input type="email" class="px-2 w-full border-t-0 border-x-0 border-green-700 lg:h-9 h-8 text-xs py-2"
              ...
              <div
                ...
                <div class="w-fit mx-auto flex">
                  <div class="flex gap-x-2 items-center w-[70px] justify-center">
                    <span>
                      <input type="radio" value="yes" v-model="info.alumni" class="mr-1" required id="yes" />
                    </span>
                  ...
                  <div class="flex gap-x-2 items-center w-[70px] justify-center">
                    <span>
                      <input type="radio" value="no" v-model="info.alumni" class="mr-1" required id="no" />
                    </span>
          ...
          <div class="lg:w-fit mb-2">
            ...
            <div class="w-full">
              <select
                ...
                <option v-for="year in _.range(moment().year(), 1930, -1)" :key="year" :value="year">
                  {{ year }}
                </option>
              </select>
            </div>
        ...
        <div class="lg:flex gap-x-2">
          <div class="w-full mb-2">
            ...
            <div class="w-full border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm p-2">
              <div class="lg:space-y-3.5">
                <div v-for="(document, index) in documentRequestOptions" :key="index"
                ...
                <div class="flex items-center">
                  <input type="checkbox" id="other_doc" value="other" v-model="showOtherDocumentField" class="mr-2" />
          ...
          <div class="w-full mb-2">
            ...
            <transition name="toast">
              <div v-if="showFileSizeToast"
                ...
                <div class="bg-red-600 text-white px-2 py-4 rounded-lg shadow-2xl border-2 border-red-700">
            ...
            <div class="w-full mb-2">
              ...
              <div class="w-full">
                ...
                <input type="file" required @change="handleGovernmentIDUpload"
                  class="lg:px-2 py-2 w-full border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm lg:h-9 h-8 text-xs"
                  id="file-upload-credential" multiple accept=".jpg,.jpeg,.png,.pdf" />

                <!-- Upload Status -->
                <div v-if="uploadStatusCredential" class="mt-2 text-xs">
                  <div :class="uploadStatusCredential.includes('successful')
                    ? 'text-green-600'
        ...
        <div class="border border-gray-300 lg:p-4 p-2 bg-white text-xs" :class="{ 'border-t-0': showPrivacyPolicy }">
          <div class="flex items-center">
            <p for="privacy_agreement" class="text-xs">
              By checking the box below, you agree with the

              <span @click="togglePrivacyPolicy" class="hover:uppercase cursor-pointer underline text-blue-800">
                Privacy Policy
              </span>
          ...
          <div class="flex items-center gap-x-1">
            <span>
              <input type="checkbox" id="privacy_agreement" v-model="info.data_privacy" :true-value="'yes'"
                :false-value="'no'" class="mt-1" required />
            </span>
            <span>
              <label for="privacy_agreement" :class="info.data_privacy === 'yes' ? 'font-bold' : ''">
                I agree
              </label>
            </span>
          </div>
        ...
        <button @click="submitForm" :disabled="!isFormValid || isSubmitting || isUploading" :class="[
          'lg:px-5 mt-5 mb-1 px-10 lg:rounded-lg rounded-md text-center font-bold py-1.5 lg:w-fit w-full mx-auto block uppercase border-2 shadow-xl',
