...
const submitForm = async () => {
  ...
  try {
    ...
    console.log("🚀 PAYLOAD:", info.value);
    console.log("✅ SUCCESS:", res);

    showToast("Submitted successfully!");

    if (res.status === "created_and_notified") {
...
<template>
  <div class="bg-gray-50">
    ...
    <div class="bg-green-700 lg:h-[200px] h-[130px]">
      <p
        class="font-bold uppercase text-white lg:text-2xl text-sm w-11/12 mx-auto pt-28"
      >
        REGISTRAR
      </p>
    ...
    <div
      class="shadow-lg text-green-700 lg:flex justify-between border-gray-200 flex items-center capitalize text-xs lg:border-b-0 border-b px-2 py-3"
    >
      <div>
    ...
    >
      ...
      <div class="lg:gap-x-2 gap-x-1 w-full p-2 bg-white">
        ...
        <div
          ...
          class="lg:px-5 mt-5 mb-1 px-10 lg:rounded-lg rounded-md text-center font-bold py-1.5 lg:w-fit w-full mx-auto block uppercase border-2 hover:bg-white hover:text-green-900 bg-green-800 text-white lg:text-sm text-xs justify-center shadow-xl cursor-pointer"
        >
