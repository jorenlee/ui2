...
const slides = ref([
  {
    id: 1,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s1.jpg",
    isChecked: true,
  },
  {
    id: 2,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s2.jpg",
    isChecked: false,
  },
  {
    id: 3,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s3.jpg",
    isChecked: false,
  },
  {
    id: 4,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s4.jpg",
    isChecked: false,
  },
  {
    id: 5,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s5.jpg",
    isChecked: false,
  },
  {
    id: 6,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s6.jpg",
    isChecked: false,
  },
  {
    id: 7,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s7.jpg",
    isChecked: false,
  },
  {
    id: 8,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s8.jpg",
    isChecked: false,
  },
  {
    id: 9,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s9.jpg",
    isChecked: false,
  },
  {
    id: 10,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s10.jpg",
    isChecked: false,
  },
  {
    id: 11,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s11.jpg",
    isChecked: false,
  },
  {
    id: 12,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s12.jpg",
    isChecked: false,
  },
  {
    id: 13,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s13.jpg",
    isChecked: false,
  },
  {
    id: 14,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s14.jpg",
    isChecked: false,
  },
  {
    id: 15,
    image:
      "https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/slides-landing-page/s15.jpg",
    isChecked: false,
  },
]);
...
<template>
  <div class="relative">
    <div class="slider lg:pt-[90px] pt-[50px] bg-green-950">
      <input
        v-for="(j, i) in slides"
        :key="i"
        type="radio"
...
/* === Active testimonial z-index and opacity === */
...
#t-15:checked ~ .testimonials label[for="t-15"] {
  z-index: 3;
  opacity: 1; /* Make the active one fully opaque */
  visibility: visible;
}

/* === Position +1 and reduced opacity === */
...
#t-15:checked ~ .testimonials label[for="t-1"] {
  ...
  z-index: 2;
  opacity: 0.3; /* Reduce opacity for the next ones */
  visibility: visible;
}

/* === Position +2 and reduced opacity === */
...
/* === Position +3 and reduced opacity === */
...
#t-2:checked ~ .testimonials label[for="t-15"] {
  transform: translate3d(-600px, 0, -180px) rotateY(25deg);
  z-index: 1;
  opacity: 0.05; /* Keep the reduced opacity */
  visibility: visible;
}
...
#t-3:checked ~ .testimonials label[for="t-15"] {
  transform: translate3d(-900px, 0, -270px) rotateY(30deg);
  z-index: 0;
  opacity: 0; /* Maintain the reduced opacity */
  visibility: visible;
}
