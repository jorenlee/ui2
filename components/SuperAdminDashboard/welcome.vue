      ...
      <div class="bg-gradient-to-r from-green-600 to-green-800 rounded-lg shadow-lg p-8 text-white mb-8">
        <div class="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-8">
          ...
          <div class="flex-1 min-w-0">
            <h1 class="text-4xl font-bold mb-2">{{ currentHour }}! 👋</h1>
          ...
          <!-- Center Section: Clock Card -->
          <div class="flex-shrink-0">
            <div class="bg-white bg-opacity-20 backdrop-blur rounded-lg p-6 border border-white border-opacity-30 whitespace-nowrap">
              <div class="flex flex-col items-center justify-center gap-3">
                <i class="fa fa-clock text-xl text-white"></i>
                <div class="text-center">
                  <p class="text-green-100 text-xs font-medium mb-1 uppercase tracking-wide">Current Time</p>
