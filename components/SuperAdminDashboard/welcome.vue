...
<div class="mb-6">
  <!-- HEADER -->
  <div class="relative overflow-hidden bg-green-600 rounded-3xl shadow-2xl lg:py-3 lg:px-10 px-5 p-6 text-white mb-4">
    <div class="relative z-10 lg:flex items-center justify-between gap-8">
      ...
      <div class="flex-1 lg:mb-0 mb-6">
        ...
        <div class="space-y-2">
          ...
          <!-- Avatar -->
          <div class="w-16 h-16 lg:w-20 lg:h-20 bg-white/20 rounded-2xl flex items-center justify-center border-2 border-white/30">
            <span class="text-2xl lg:text-3xl font-bold">  <img
      ...
      <div class="lg:w-auto w-full">
        <div class="bg-white/15 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
