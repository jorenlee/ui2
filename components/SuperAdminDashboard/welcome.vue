...
const recentActivities = [
  ...
  },
  {
    ...
    description: "Library appointment booked",
    time: "4 hours ago",
    icon: "fa-calendar",
    color: "text-blue-500",
  },
  {
    action: "Book Added",
    description: "New book available",
    time: "1 day ago",
    icon: "fa-book",
...
<template>
  <div class="bg-gray-50 min-h-screen">
    <div class="">
      <!-- ================= WELCOME HEADER ================= -->
      <div
        class="bg-gradient-to-r from-green-600 to-green-800 rounded-lg shadow-lg lg:p-8 p-4 text-white mb-8"
      >
        <div
          class="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-8"
        >
          <!-- GREETING -->
          <div class="w-fit">
            ...
            >
              <div class="flex flex-col items-center justify-center gap-3">
                ...
                <div class="text-center">
                  <p
                    class="text-green-100 text-xs font-medium uppercase tracking-wide mb-1"
                  >
                    Current Time
                  </p>
                  <p
                    class="text-white text-3xl font-bold font-mono leading-none"
                  >
                    {{ currentTime }}
                  </p>
                </div>
              ...
              <div class=" mx-auto w-fit mt-3 lg:flex hidden">
                <div
              ...
              >
                <div class="flex items-start gap-4">
                  <div class="flex-shrink-0 pt-1">
                    <i
                      :class="['fa text-xl', activity.icon, activity.color]"
                    ></i>
                  </div>
                  <div class="flex-1">
