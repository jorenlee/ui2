                            ...
                            >
                              ...
                              <div class="w-full space-y-4">
                                ...
                                >
                                  ...
                                  >
                                    <i
                                      class="fa fa-graduation-cap text-green-600"
                                    ></i>
                                  ...
                                  <div class="lg:flex lg:gap-4">
                                    ...
                                    <div class="mb-4 w-full">
                                      ...
                                      >
                                        <i
                                          class="fa fa-graduation-cap text-green-500 mr-2"
                                        ></i>
                                        ICC / LSU Graduate?
                                      </label>
                                      <select
                                    ...
                                    <div class="mb-4 w-full">
                                      ...
                                      >
                                        <i
                                          class="fa fa-calendar text-green-500 mr-2"
                                        ></i>
                                  ...
                                  <div class="mb-4">
                                    ...
                                    >
                                      <i
                                        class="fa fa-university text-green-500 mr-2"
                                      ></i>
                                      College
                                    </label>
                                    <select
                                  ...
                                  <div class="mb-4">
                                    ...
                                    >
                                      <i
                                        class="fa fa-book text-green-500 mr-2"
                                      ></i>
                                      Course
                                    </label>
                                    <input
                                  ...
                                  >
                                    ...
                                    >
                                      <i
                                        class="fa fa-info-circle text-green-600 mr-2"
                                      ></i>
                                      Purpose and Details:
                                    </p>
                                    <p
                                  ...
                                  >
                                    <h4
                                      class="text-xs font-bold mb-2 flex items-center uppercase"
                                    >
                                    ...
                                    <div class="space-y-1">
                                      <div
                                        v-for="(
                                          doc, idx
                                        ) in b.detail_fees_type_document_requests"
                                        :key="idx"
                                      ...
                                      >
                                        <i
                                          class="fa fa-check-circle text-blue-500 text-[10px]"
                                        ></i>
