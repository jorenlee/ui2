          ...
          >
            ...
            <li class="flex items-center">
              ...
              <a href="/administration" class="flex">
                President & &nbsp;
                <span class="lg:flex hidden">Vice Presidents</span>
                <span class="lg:hidden flex"> Vice Presidents</span>
              </a>
            </li>
          </ul>
        </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span class="lg:w-2/12 lg:flex block pr-3 lg:order-1 order-2">
                    {{ aa.officeAbbr }}
                  </span>
                </h1>
              </div>
