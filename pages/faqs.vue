...
// FAQ DATA (with "open" state included)
const faqs = ref([
  {
...
const toggleAccounts = (index) => {
  faqsAccounts.value[index].open = !faqsAccounts.value[index].open;
};
</script>
