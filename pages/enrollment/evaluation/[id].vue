...
let evaluationData = ref({
  ...
  personal_email_address: enrollee.student_contact_info.contact.personal_email_address,
  evaluation_form: {
    main_question: [
      {
        ...
        <div>
          <div class="border mb-10">
            ...
            <div class="w-full">
              <div class="lg:flex gap-20 border-b-2 border-green-900 py-4">
                ...
                <ul class="w-full flex items-center">
                  <li class="justify-center text-center w-full text-sm lg:pt-0 pt-2 lg:px-3 px-1"
                    ...
                    <span class="block text-white py-1 px-2.5 mb-2 font-bold w-fit mx-auto rounded-full bg-green-900 ">
                      {{ j.number }}</span>
                    <span
              ...
              <div class="shadow">
                <ul>
                  <li v-for="(j, i) in evaluationData.evaluation_form.main_question[0].question_list" :key="i"
          ...
          <div class="border">
            ...
            <div class="w-full">
              ...
              <div class="shadow">
                <ul>
                  <li v-for="(j, i) in evaluationData.evaluation_form.main_question[1].question_list" :key="i"
                    class="lg:flex items-center gap-20 border-b py-3">
                    <p class="lg:w-7/12 flex items-center text-sm px-3 lg:border-none border-b-2 lg:pb-0 pb-3">
                      <span class="font-bold text-white bg-green-900 px-2 text-xs rounded-full py-1 mr-3 w-fit h-fit">{{
                        i
