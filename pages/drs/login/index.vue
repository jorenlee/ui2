      ...
      <div class="lg:w-7/12 py-5 w-11/12 mx-auto">
        <div class="">
          <div class="lg:flex md:w-fit w-full mx-auto gap-10 items-center lg:py-14 py-8 md:px-10 px-7 lg:px-16 shadow bg-white my-auto
            ...
            <img class="w-24 lg:mx-0 mx-auto h-auto block lg:mb-0 mb-5" 
            ...
            <div class="">
              ...
              <button :disabled="!isReady" @click="login" class="h-fit pl-12 pr-3 py-3 bg-[#003613] rounded-lg text-sm text-white text-center font-semibold lg:w-auto w-full
