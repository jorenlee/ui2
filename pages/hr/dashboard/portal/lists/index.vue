    ...
    <div class="flex">
      ...
      <div class="w-full min-h-screen">
        ...
        <div class="relative">
          <div>
            <div
              class="w-11/12 mx-auto shadow lg:px-5 px-4 lg:pt-5 pt-3 my-10 rounded-lg"
            >
              <h1
                class="text-center text-green-700 font-bold lg:text-3xl text-lg"
              >
              ...
              <div class="w-full rows" v-if="careers.length > 0">
                <ul class="lg:grid grid-cols-5 gap-x-3 lg:py-10">
                  ...
                  >
                    ...
                    >
                      <img
                        class="lg:mx-0 mx-auto w-full h-[200px]"
                        :src="`${j.url}`"
                      />
                    </div>
                  </li>
