    ...
    <div class="">
        ...
        <NuxtLink to="/">
          <h1 class=" items-center lg:mx-auto mx-3 lg:w-fit">
            <span class="mx-auto">
              <img src="https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/banners/logo/lsuseal-mono.png" class="lg:w-6/12 my-10 px-1 mx-auto"/>
            </span>
            <span class="text-center">
              ...
              <span class="lg:whitespace-nowrap  text-2xl font-bold font-hk-compression -mt-2 flex capitalize text-center mx-auto w-fit">support our mission</span>
            </span>
          </h1>
        </NuxtLink>
...
<div class=" align-baseline mt-2 text-[10px]  mx-auto text-center items-center">
  ...
  <div class="bg-[#087830] text-white w-full my-2">
          <ul class="flex text-center w-fit mx-auto uppercase">
            ...
            <NuxtLink to="/donation/privacy">
              <li class=" text-white py-2 lg:text-base lg:mx-10 mx-5 text-xs text-center hover:font-bold hover:underline cursor-pointer static whitespace-nowrap font-montserrat">Privacy </li>
            </NuxtLink>
...
<div class="block w-full">
    <p> © Copyright All Rights Reserved 2024 |
La Salle University-Ozamiz, Inc.</p>
    </div>
<div class="block w-full">
...
<div class="w-full bg-[#004e33] min-h-screen flex items-center pt-5">
     ...
     <div class="lg:pt-0 pb-5 w-full">
       ...
       <div class=" w-11/12 mx-auto lg:shadow-lg lg:border-b-0 lg:pb-5 pb-3 bg-white">
        <div class="bg-[#087830] text-white">


          
          
            <h2 class="font-hk-compression  font-bolder text-center text-4xl lg:pb-2 pb-3 pt-4">Donate Now</h2>
            <div class="h-1 bg-white w-full mb-2"></div>
            <p class="font-monteserrat text-center  font-bold text-sm flex w-fit mx-auto pb-2"><TotalDonationNumberOnly/></p>
        </div>
     <div class="p-5">
